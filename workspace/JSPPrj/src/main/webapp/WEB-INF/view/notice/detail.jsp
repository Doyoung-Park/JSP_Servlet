				...
				<div class="margin-top first">
						...
						<table class="table">
							<tbody>
								...
								<tr>
									<th>작성일</th>
									<td class="text-align-left text-indent" colspan="3"> <fmt:formatDate value="${n.regdate}" pattern="yyyy년 MM월 dd일 hh:mm:ss"/></td>
								</tr>
								<tr>
									<th>작성자</th>
									<td>${n.writerID}</td>
									<th>조회수</th>
									<td><fmt:formatNumber type="number" pattern="#,#### 번" value="${n.hit}"/> </td>
								</tr>
								<tr>
									<th>첨부파일</th>
